...
function TimerClass(_nSetTime,_nVector)
{
	this.nTime	=	_nSetTime;	
	this.nVector	=	_nVector;	
	this.nStartSec	=	(new Date()).getSeconds();
	this.nNowSec	=	this.nStartSec;

	
	function TimerClass_SetTimer(_nSetTime)
	{
		this.nTime	=	_nSetTime;
		this.nStartSec	=	(new Date()).getSeconds();
		this.nNowSec	=	this.nStartSec;
	}
	TimerClass.prototype.SetTimer = TimerClass_SetTimer;

	
	function TimerClass_GetTimer()
	{
		this.nNowSec	=	(new Date()).getSeconds();
	...
	TimerClass.prototype.GetTimer = TimerClass_GetTimer;
