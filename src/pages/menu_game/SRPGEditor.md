...
|ゲーム名|制作者|DL|
|Sシミュレーション|７７７様|[ダウンロード](/soft/SRPGEditor/g02.zip)|
|制作者のコメント|Sは「ショート」のSです。  <br>その名の通り、かなり簡潔な作りになっており、元のデータもほとんど変えてません。|   |
|ゲーム名|制作者|DL|
|タンポーの旅 さらなる悪魔編|チコ様|~~[ダウンロード](/soft/SRPGEditor/g01.zip)~~|
...
|Venusのキャラクター集|キャラクター画像|Venus様|○|○|[ダウンロード](/soft/SRPGEditor/m02.zip)|
|制作者のコメント|SRPGエディター用に描いた物ですが、使い道はご自由に。|   |   |   |   |
|素材名|種別|制作者|加工|シミュエディ以外での利用|DL|
|はしぶとガラスの  <br>へんてこエフェクト集|エフェクト画像|[はしぶとガラス様](http://bloodhouse.hp.infoseek.co.jp/table.htm)|○|○|[ダウンロード](/soft/SRPGEditor/m01.zip)|
